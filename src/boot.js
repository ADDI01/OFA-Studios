export default class Boot extends Phaser.Scene {
    ...
    create() {
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('DigDug_mov', { start: 0, end: 1 }),
            frameRate: 24,
            yoyo: true,
            repeat: -1
        })
        this.anims.create({
            key: 'player_mov_up',
            frames: this.anims.generateFrameNumbers('DigDug_mov', { start: 2, end: 3 }),
            frameRate: 24,
            yoyo: true,
            repeat: -1
        })
        this.anims.create({
            key: 'player_mov_left',
            frames: this.anims.generateFrameNumbers('DigDug_mov', { start: 4, end: 5 }),
            frameRate: 24,
            yoyo: true,
            repeat: -1
        })
        this.anims.create({
            key: 'player_mov_down',
            frames: this.anims.generateFrameNumbers('DigDug_mov', { start: 6, end: 7 }),
            frameRate: 24,
            yoyo: true,
            repeat: -1
        })
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('DigDug_mov', { start: 1, end: 1 }),
            frameRate: 6,
            repeat: -1
        })
        ...
        this.anims.create({
            key: 'player_idle_up',
            frames: this.anims.generateFrameNumbers('DigDug_mov', { start: 3, end: 3 }),
            frameRate: 6,
            repeat: -1
        })
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('DigDug_mov', { start: 5, end: 5 }),
            frameRate: 6,
            repeat: -1
        })
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('DigDug_mov', { start: 7, end: 7 }),
            frameRate: 6,
            repeat: -1
        })
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('DigDug_dig', {start: 0, end: 1}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_digging_up',
            frames: this.anims.generateFrameNumbers('DigDug_dig', {start: 2, end: 3}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_digging_left',
            frames: this.anims.generateFrameNumbers('DigDug_dig', {start: 4, end: 5}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_digging_down',
            frames: this.anims.generateFrameNumbers('DigDug_dig', {start: 6, end: 7}),
            frameRate: 12,
            repeat: -1
        });
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('DigDug_throw_pump', {start: 0, end: 0}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_throwing_pump_up',
            frames: this.anims.generateFrameNumbers('DigDug_throw_pump', {start: 1, end: 1}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_throwing_pump_left',
            frames: this.anims.generateFrameNumbers('DigDug_throw_pump', {start: 2, end: 2}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_throwing_pump_down',
            frames: this.anims.generateFrameNumbers('DigDug_throw_pump', {start: 3, end: 3}),
            frameRate: 12,
            repeat: -1
        });
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('DigDug_inflate', {start: 0, end: 1}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_inflate_up',
            frames: this.anims.generateFrameNumbers('DigDug_inflate', {start: 2, end: 3}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_inflate_left',
            frames: this.anims.generateFrameNumbers('DigDug_inflate', {start: 4, end: 5}),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
            key: 'player_inflate_down',
            frames: this.anims.generateFrameNumbers('DigDug_inflate', {start: 6, end: 7}),
            frameRate: 12,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'fygar_mov_right',
            frames: this.anims.generateFrameNumbers('Fygar_movAndsmashed_right', { start: 0, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'fygar_mov_left',
            frames: this.anims.generateFrameNumbers('Fygar_movAndsmashed_left', { start: 0, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('Fygar_eyes_right', { start: 0, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'fygar_hunting_left',
            frames: this.anims.generateFrameNumbers('Fygar_eyes_left', { start: 0, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('Fygar_movAndsmashed_right', { frames: [0, 3] }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'fygar_warning_left',
            frames: this.anims.generateFrameNumbers('Fygar_movAndsmashed_left', { frames: [0, 3] }),
            frameRate: 12,
            repeat: -1
        })
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('Fygar_flames1', { start: 0, end: 0 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'fygar_first_fire_left',
            frames: this.anims.generateFrameNumbers('Fygar_flames1', { start: 1, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'fygar_second_fire_right',
            frames: this.anims.generateFrameNumbers('Fygar_flames2', { start: 0, end: 0 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'fygar_second_fire_left',
            frames: this.anims.generateFrameNumbers('Fygar_flames2', { start: 1, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'fygar_third_fire_right',
            frames: this.anims.generateFrameNumbers('Fygar_flames3', { start: 0, end: 0 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'fygar_third_fire_left',
            frames: this.anims.generateFrameNumbers('Fygar_flames3', { start: 1, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        ...
        this.anims.create({
            key: 'pooka_mov_right',
            frames: this.anims.generateFrameNumbers('Pooka_movRight', { start: 0, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'pooka_mov_left',
            frames: this.anims.generateFrameNumbers('Pooka_movLeft', { start: 0, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
        this.anims.create({
            key: 'pooka_idle_right',
            frames: this.anims.generateFrameNumbers('Pooka_movRight', { start: 0, end: 0 }),
            frameRate: 6,
            repeat: -1
        })
        this.anims.create({
            key: 'pooka_idle_left',
            frames: this.anims.generateFrameNumbers('Pooka_movLeft', { start: 0, end: 0 }),
            frameRate: 6,
            repeat: -1
        })
        ...
        this.anims.create({
            key: 'pooka_hunting',
            frames: this.anims.generateFrameNumbers('Pooka_eyes', { start: 0, end: 1 }),
            frameRate: 12,
            repeat: -1
        })
